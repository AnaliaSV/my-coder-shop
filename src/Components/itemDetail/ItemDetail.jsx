                ...
                <div className="flex-detail" bg='secondary' text='white' style={{minHeight:'550px'}}>
                   <div className="title-img-detail">                                         
                    ...
                    <div className='description-name-button-detail'>    
                        ...
                        <p className="text-start margin-bottom"> Telgo Diama de 2 plazas cuenta con estructura de resortes Bonell bicónicos de acero templado entrelazados y marco perimetral que aporta rigidez. </p>
